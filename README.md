...
<p>
    ...
    <a href="https://github.com/aisphereio/soft-serve/releases"><img src="https://img.shields.io/github/release/charmbracelet/soft-serve.svg" alt="Latest Release"></a>
    <a href="https://pkg.go.dev/github.com/aisphereio/soft-serve?tab=doc"><img src="https://godoc.org/github.com/golang/gddo?status.svg" alt="GoDoc"></a>
    <a href="https://github.com/aisphereio/soft-serve/actions"><img src="https://github.com/aisphereio/soft-serve/workflows/build/badge.svg" alt="Build Status"></a>
...
<picture>
  <source media="(max-width: 750px)" srcset="https://github.com/aisphereio/soft-serve/assets/42545625/c754c746-dc4c-44a6-9c39-28649264cbf2">
  <source media="(min-width: 750px)" width="750" srcset="https://github.com/aisphereio/soft-serve/assets/42545625/c754c746-dc4c-44a6-9c39-28649264cbf2">
  <img src="https://github.com/aisphereio/soft-serve/assets/42545625/c754c746-dc4c-44a6-9c39-28649264cbf2" alt="Soft Serve screencast">
</picture>
...
[releases]: https://github.com/aisphereio/soft-serve/releases

Or just install it with `go`:

```bash
go install github.com/aisphereio/soft-serve/cmd/soft@latest
```

A [Docker image][docker] is also available.

[docker]: https://github.com/aisphereio/soft-serve/blob/main/docker.md
...
[systemd]: https://github.com/aisphereio/soft-serve/blob/main/systemd.md
...
```sh
ssh -p 23231 localhost repo import soft-serve https://github.com/aisphereio/soft-serve
```
...
[contribute]: https://github.com/aisphereio/soft-serve/contribute
...
[MIT](https://github.com/aisphereio/soft-serve/raw/main/LICENSE)
